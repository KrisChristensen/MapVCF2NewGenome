...
parser.add_argument("-map", help = "The location of the file output by Bam2SNPPosition.v1.0.py and verified with CheckMappingVCF.v1.0.py", default=sys.stdin, required=True)
