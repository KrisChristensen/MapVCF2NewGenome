...
parser.add_argument("-chr", help = "Only look for at variants on this scaffold, could be used for parallel processing, default=all, option=scaffold_name", default="all")
    ...
    def readLinesVCF(self, vc):
        ...
        for line in self.open_vcf:
            ...
            if not re.search("^#", line):     
                ...
                if args.chr == "all" or args.chr == self.chrom:
